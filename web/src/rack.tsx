...
export const RACK_MANIFESTS: Record<RackModuleId, RackModuleManifest> = {
  ...
  palace_nebula: {
    ...
    bindings: [
      ...
      'memory.revisions.ts', 'memory.revisions.reason',
      'memory_graph.edges.similarity', 'memory_graph.edges.lineage',
      'scorer.learning.retrain_runs', 'scorer.learning.annotations',
    ],
  ...
  injection_console: {
    ...
    bindings: [
      'scorer.tau', 'scorer.memory_context_share',
