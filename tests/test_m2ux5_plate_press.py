...
def test_canonical_plate_reuses_the_exact_m2ux4_clusters_and_shares(tmp_path: Path) -> None:
    """PLAN M2UX5, B.6 r12, and D.2 107-114 bind product intake to the ratified extractor."""
...
def test_second_real_image_yields_a_lawful_named_colorway(tmp_path: Path) -> None:
    """PLAN M2UX5, B.6 r12, and D.2 114 require a real second image, not a synthetic-only pass."""
