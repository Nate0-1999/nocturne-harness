...
const [feed = '/m3vl-dev/feed-real.json', tier = 'efficient'] = process.argv.slice(2)
...
try {
  await page.goto(`http://localhost:${server.httpServer.address().port}/m3vl-dev/perf.html?feed=${feed}&tier=${tier}`)
