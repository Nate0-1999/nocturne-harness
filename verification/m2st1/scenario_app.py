"""Current-shape, local-only Rack fixture for M2ST1 stage handling."""
...
def create_scenario_app() -> FastAPI:
    settings = HarnessSettings(
        principal_id="m2st1-verification",
        machine_id="m2st1-verification",
        agent_id="m2st1-verification",
        chat_model="local:m2st1-verification",
    ...
    app = FastAPI(title="M2ST1 deterministic stage verification")
    install_fixture_isolation(app, "M2ST1 REGRESSION")
