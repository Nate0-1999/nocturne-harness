"""Current-shape, local-only Rack fixture for M2ST2 chrome verification."""
...
def create_scenario_app() -> FastAPI:
    settings = HarnessSettings(
        principal_id="m2st2-verification",
        machine_id="m2st2-verification",
        agent_id="m2st2-verification",
        chat_model="local:m2st2-verification",
    ...
    app = FastAPI(title="M2ST2 deterministic chrome verification")
    install_fixture_isolation(app, "M2ST2 REGRESSION")
