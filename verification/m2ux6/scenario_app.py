"""Current-shape, isolated Rack fixture for the M2UX6 grimoire acceptance pass."""
...
def create_scenario_app() -> FastAPI:
    settings = HarnessSettings(
        principal_id="m2ux6-verification",
        machine_id="m2ux6-verification",
        agent_id="m2ux6-verification",
        chat_model="local:m2ux6-verification",
    ...
    app = FastAPI(title="M2UX6 deterministic grimoire verification")
    install_fixture_isolation(app, "M2UX6 REGRESSION")
